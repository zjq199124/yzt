...
public class DictCommonController {
    ...
    @ApiOperation(value = "获取症状分科列表", notes = "获取症状分科列表")
    @ApiImplicitParams({})
    @GetMapping("/getSymptomTypeList")
    public Result getSymptomTypeList() {
        List<Map<String, Object>> list = service.getSymptomTypeList();
        return Result.success(list);
    }
}
